...
const PriceDetails = () => {
  ...
  return (
    <div className="flex flex-col max-h-80 w-100 p-5 gap-4 rounded-xl overflow-hidden shadow-lg bg-sky-50 border-2 border-blue-200">
      ...
      {deliveryCharges>0?
        "Not Eligible for free shipping":"Eligible for free shipping"
      }
</div>
      {/* <h3>You will save .... on this order</h3> */}

      <button className="bg-blue-500 font-semibold  cursor-pointer text-white px-4 py-2 rounded-full hover:bg-green-600 focus:outline-none transition ">
        Place Order
      </button>
    </div>
  );
